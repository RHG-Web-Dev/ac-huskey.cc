export const siteConfig = {
  ...
  aboutMe:
    "Aspiring IT professional with a passion for computer networking and a strong foundation in troubleshooting, network configuration, and security. Eager to apply my skills and knowledge in a dynamic IT environment while continuously learning and growing in the field.",
